          ...
          <div className="footer-grid">
            ...
            <div className="footer-column">
              ...
              <div className="social-links">
                ...
                <a href="https://www.instagram.com/fuji_cards?igsh=MXZybHY2anNwenJrZw%3D%3D&utm_source=qr" target="_blank" rel="noreferrer" className="social-icon" aria-label="Instagram">
